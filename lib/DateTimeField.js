...
var DateTimeField = (function (_Component) {
  ...
  function DateTimeField() {
    ...
    this.addMonth = function () {
      return _this.setState({
        viewDate: _this.state.viewDate.clone().add(1, "months")
      });
    };

    this.addYear = function () {
      return _this.setState({
        viewDate: _this.state.viewDate.clone().add(1, "years")
      });
    };

    this.addDecade = function () {
      return _this.setState({
        viewDate: _this.state.viewDate.clone().add(10, "years")
      });
    };
    ...
    this.subtractMonth = function () {
      return _this.setState({
        viewDate: _this.state.viewDate.clone().subtract(1, "months")
      });
    };

    this.subtractYear = function () {
      return _this.setState({
        viewDate: _this.state.viewDate.clone().subtract(1, "years")
      });
    };

    this.subtractDecade = function () {
      return _this.setState({
        viewDate: _this.state.viewDate.clone().subtract(10, "years")
      });
    };
